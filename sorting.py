...
# one element at a time. It iterates through the list, removing one element each time 
# and finding the correct position to insert it in the already-sorted portion.
